...
# Carga los datos
paths = {
    "600": "./transformers/abc_transformer_model600/checkpoint-36140/trainer_state.json",
    "1200": "./transformers/abc_transformer_model1200/checkpoint-37155/trainer_state.json",
    "3000": "./transformers/abc_transformer_model3000/checkpoint-37680/trainer_state.json"
}
